...
public class RestApiResponseImpl implements RestApiResponse {
    ...
    protected RestApiResponseImpl(Serializable response, int httpStatus, Map<String, String> additionalHeaders, List<Cookie> additionalCookies,
            String mediaType, String characterSet) {
